...
while not invite_code.isalnum() or invite_code.islower():
    invite_code = input("邀请码格式错误，请重新输入(英文为大写)：")

num_invites = int(input("请输入要邀请的人数："))
while num_invites <= 0:
    num_invites = int(input("邀请人数必须大于0，请重新输入："))
...
def register():
    ...
    data = 'passwd=e10adc3949ba59abbe56e057f20f883e&email=' + email + '&invite_code=' + invite_code  # 发送的内容，密码我就写的123456，想改自己MD5加密一下
    #  获取时间戳
...
if __name__ == '__main__':
    for i in range(1, num_invites + 1):
        register()
        print("\n已邀请{}个人".format(i))
